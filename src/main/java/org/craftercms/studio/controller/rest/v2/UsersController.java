...
import org.craftercms.studio.model.users.DeleteUserPropertiesRequest;
...
public class UsersController {
    ...
    @DeleteMapping(value = ME + PROPERTIES, consumes = APPLICATION_JSON_VALUE, produces = APPLICATION_JSON_VALUE)
    public ResponseBody deleteUserProperties(@Valid @RequestBody DeleteUserPropertiesRequest request) throws ServiceLayerException {
        var result = new ResultOne<Map<String, String>>();
        result.setResponse(OK);
        result.setEntity("properties", userService.deleteUserProperties(request.getSiteId(), request.getProperties())); //TODO: Extract key
